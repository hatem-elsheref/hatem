...
export function WhatsAppFloat() {
  ...
  // Remove + and spaces from WhatsApp number for URL
  const whatsappNumber = portfolioData.contact.whatsapp.replace(/[+\s]/g, "");
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-full mr-4 hidden group-hover:block">
        <div className="rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-3 py-2 text-sm font-medium whitespace-nowrap shadow-lg">
          Chat on WhatsApp
